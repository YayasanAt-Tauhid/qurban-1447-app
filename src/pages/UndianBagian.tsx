  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto pb-10">
      ...
      <div className="page-header">
        ...
        <h1 className="page-title">Fitur Pembagian Bagian Resmi Tidak Tersedia</h1>
        <p className="page-subtitle">Fitur ini telah dipindahkan ke versi lain untuk pengembangan terpisah.</p>
      </div>
  );
